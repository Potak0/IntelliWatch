...
#define MPU9250_WOM_THR (0x1F)//Wake up on Motion Threshold,0-255,0-1020mg

#define MPU9250_RA_ACCEL_CONFIG_2_FCHOICE_B_BIT (3)//bit3,bit2
#define MPU9250_RA_ACCEL_CONFIG_2_FCHOICE_B_LENGTH (2)
#define MPU9250_RA_ACCEL_CONFIG_2_A_DLPFCFG_BIT (2)//bit1,bit0
#define MPU9250_RA_ACCEL_CONFIG_2_A_DLPFCFG_LENGTH (2)
#define MPU9250_RA_INT_PIN_CFG (0x37)

#define MPU9250_RA_INT_ENABLE (0x38)//Set the whole register to 0x40 to enable the wom interrupt
#define MPU9250_RA_INT_WOM_EN_BIT (6)//Set this bit to 1 to enable the wom interrupt only
#define MPU9250_RA_INT_FIFO_OVERFLOW_EN_BIT (4)//0
#define MPU9250_RA_INT_FSYNC_INT_EN_BIT (3)//0
#define MPU9250_RA_INT_DATA_RDY_EN_BIT (0)//0
...
#define MPU9250_MOT_ACCEL_INT_EL_EN_BIT (7)
#define MPU9250_MOT_ACCEL_INT_EL_EN_MODE_BIT (6)
...
#define MPU9250_PWR1_STANDBY_BIT (4)
#define MPU9250_PWR1_TEMP_DIS_BIT (3)
#define MPU9250_PWR1_CLKSEL_BIT (0)
#define MPU9250_PWR1_CLKSEL_LENGTH (3)

#define MPU9250_PWR2_DISABLE_XA_BIT (5)//1:disabled 0:enabled
#define MPU9250_PWR2_DISABLE_YA_BIT (4)
#define MPU9250_PWR2_DISABLE_ZA_BIT (3)
#define MPU9250_PWR2_DISABLE_XG_BIT (2)
#define MPU9250_PWR2_DISABLE_YG_BIT (1)
#define MPU9250_PWR2_DISABLE_ZG_BIT (0)
...
esp_err_t mpu9250_wake_on_motion_deinit(void);
