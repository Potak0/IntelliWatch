...
#define THRESHOLD 200//200:the first success, takes a hard shock 
                    //50:the second success, takes a softer yet still too hard
                    //30:the third success, softer and softer
...
esp_err_t i2c_mpu9250_init(calibration_t *c)
{
  ...
  // ESP_ERROR_CHECK(i2c_master_init(I2C_MASTER_NUM, I2C_MASTER_SDA_IO, I2C_MASTER_SCL_IO));//I2C Init
...
esp_err_t mpu9250_wake_on_motion_config(void)
{
  ESP_LOGW(TAG, "mpu9250_wake_on_motion_config");
  // writeByte(&hi2c1, MPU9250->I2C_Addr, PWR_MGMT_1, 0x01);
  //  i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_RA_PWR_MGMT_1, 0x01);
  // 0x6c, 0b00000111 writeByte(&hi2c1, MPU9250->I2C_Addr, PWR_MGMT_2, 0x07);
  ESP_ERROR_CHECK(i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_RA_PWR_MGMT_2, 0x07));
  // ESP_ERROR_CHECK(i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_RA_ACCEL_CONFIG_2, 0x05)); //184Hz
  ESP_ERROR_CHECK(i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_RA_ACCEL_CONFIG_2, 0x08)); //460Hz
  ESP_ERROR_CHECK(i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_RA_INT_ENABLE, 0x40));

  ESP_ERROR_CHECK(i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_MOT_DETECT_CTRL, 0xC0));

  ESP_ERROR_CHECK(i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_WOM_THR, THRESHOLD));
  ESP_ERROR_CHECK(i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, 0x1E, 0x0B)); // LP_ACCEL_ODR,0-11
  ESP_ERROR_CHECK(i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_RA_INT_PIN_CFG, 0x32));

  // ESP_ERROR_CHECK(i2c_write_byte(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_RA_PWR_MGMT_1, 0x21));
  ESP_ERROR_CHECK(i2c_write_bit(I2C_MASTER_NUM, MPU9250_I2C_ADDR, MPU9250_RA_PWR_MGMT_1, 5, 1));
